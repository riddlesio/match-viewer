(function (undefined) {
    ...
    const
        ...
        AbstractUIComponent = require('./AbstractUIComponent');
    ...
    MoveSelector = createClass(AbstractUIComponent, {
        ...
        construct: function (options) {
            ...
            // Create settings
            var state = _.extend({}, options, defaults);
        ...
        toggle: function () {
            ...
            self.state.isExpanded ? self.collapse() : self.expand();
        },
        ...
        setSelected: function (index) {
            ...
            var amountOfMoves = this.state.moves.length;
